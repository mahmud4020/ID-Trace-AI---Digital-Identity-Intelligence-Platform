...
// Fetch global bonus settings for display
...
<body class="min-h-screen text-slate-900 font-sans antialiased flex flex-col justify-between selection:bg-[#128c7e] selection:text-white bg-slate-50 relative">
    ...
    <script>
        ...
        function calculateProjections() {
            ...
            // All plans: flat bonus amount per billing cycle
            const bonusAmount = <?= $portal_bonus_amount ?>;
            const bonusType = '<?= $portal_bonus_type ?>';
            // M1: billing monthly, Q3: billing quarterly, B6: billing semi-annually, Y12: billing annually
